...
import { M as MarkdownEditor, T as TagInput, S as StatsEditor } from './MarkdownEditor-CaVqMs1B.js';
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `${$$result.head += `<!-- HEAD_svelte-14sd4o7_START -->${$$result.title = `<title>Creating ${escape("a character")}</title>`, ""}<meta name="author" content="Add a character"><meta name="description" content="Find and host any original characters"><meta property="og:title" content="Add a character"><meta property="og:description" content="Find and host any original characters"><meta property="og:image" content="https://persona-db.xyz/favicon.png"><!-- HEAD_svelte-14sd4o7_END -->`, ""} <main><div class="container">${``} ${``} <div class="box svelte-1icyjj8"><div class="inline-name svelte-1icyjj8"><h1 class="svelte-1icyjj8" data-svelte-h="svelte-ynt621">Character :</h1> <input type="text" name="name" id="name" placeholder="Give a name to the character" autocomplete="off"${add_attribute("value", character.name, 0)} class="svelte-1icyjj8"> <button data-svelte-h="svelte-n5fxji">Create</button></div> ${validate_component(MarkdownEditor, "MarkdownEditor").$$render(
      ...
      {}
    )}</div> <div class="stats-box svelte-1icyjj8"><h3 data-svelte-h="svelte-5zwsxb">Stats</h3> ${validate_component(StatsEditor, "StatsEditor").$$render(
      $$result,
      { data: statsData },
      {
        data: ($$value) => {
...
//# sourceMappingURL=_page.svelte-CI0egNS1.js.map
